...
import { Layers, Plus, Shield, FileText, BarChart3, Trash2 } from 'lucide-react'
    ...
    <div>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-16 bg-white/5 border border-white/10 rounded-2xl">
          ...
          <p className="text-gray-400">Create your first space to start generating security requirements</p>
        </div>
      ) : (
